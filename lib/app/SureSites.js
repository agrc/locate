define([
    ...
    return declare([_WidgetBase, _TemplatedMixin], {
        ...
        setupConnections: function () {
            ...
            $(this.filtersContainer).on('shown.bs.collapse', lang.partial(lang.hitch(this, this.toggleLayer), true));
            ...
            topic.subscribe(config.topics.router.toggleLayers, lyrs => {
                ...
                if (lyrs.includes(`${config.sureSitesLayerIndex}`)) {
                    $(this.filtersContainer).collapse('show');
                }
            });
        },
