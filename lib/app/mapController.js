define([
    ...
    var MC = declare([Destroyable], {
        ...
        initMap: function (mapDiv) {
            ...
            this.own(
                ...
                this.map.on('load', function () {
                    ...
                    this.map.infoWindow.disableHighlights(this.map);
                }.bind(this)),
        ...
        onMapClick: function (evt) {
            ...
            if (!evt.graphic || this.map.graphics.graphics.indexOf(evt.graphic) === -1) {
                this.map.graphics.clear();
            }

            // skip if an existing graphic was clicked on
            if (evt.graphic) {
